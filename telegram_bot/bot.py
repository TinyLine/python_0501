...
async def about_message(message: Message):
    await message.answer(" 🤖 Привіт! Я твій помічник у світі ігор та розваг. Ось що я вмію: 🎮 Перегляд знижок Steam – дізнавайся про найкращі ігрові пропозиції зі знижками 90%+ 📰 Геймерські новини – читай свіжі новини про ігри та індустрію 🪙 Кинути монетку – підкинь монетку та перевір свою удачу Натисни одну з кнопок нижче, щоб почати! 🚀 ")
